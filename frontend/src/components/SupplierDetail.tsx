      ...
      <div style={modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          <div style={{
            ...
            {supplier.reasoning ?? "No evidence-backed assessment has been recorded."}
          </div>
        </div>
        ...
        <p style={{ marginTop: "20px", fontSize: "0.75rem", color: "#9ca3af", textAlign: "center" }}>
          Connector truth: paid AI and n8n automation are not connected by default.
        </p>
      </div>
    </div>
  );
